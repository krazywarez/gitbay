...
func (s *Server) Routes() []Route {
	...
	routes = append(routes,
		...
		Route{Method: "GET", Pattern: "/search", Handler: s.globalSearch},
	...
	routes = append(routes,
		...
		Route{Method: "GET", Pattern: "/{owner}/-/repositories", Handler: s.ownerProfile},
		Route{Method: "GET", Pattern: "/{owner}/-/bookmarks", Handler: s.ownerProfile},
		Route{Method: "GET", Pattern: "/{owner}/-/people", Handler: s.ownerProfile},
		...
		Route{Method: "GET", Pattern: "/{owner}/-/snippets", Handler: s.ownerProfile},
	...
	if s.cfg.Web.Mode == "accounts" {
		routes = append(routes,
			...
			Route{Method: "GET", Pattern: "/settings/export", Handler: s.requireUser(s.accountExport)},
			Route{Method: "GET", Pattern: "/notifications", Handler: s.requireUser(s.notifications)},
			Route{Method: "POST", Pattern: "/notifications", Mutating: true,
				Handler: s.checkOrigin(s.requireUser(s.notificationsRead))},
			Route{Method: "GET", Pattern: "/admin", Handler: s.requireUser(s.adminPage)},
			Route{Method: "GET", Pattern: "/admin/users", Handler: s.requireUser(s.adminUsers)},
			Route{Method: "POST", Pattern: "/admin/users", Mutating: true,
				Handler: s.checkOrigin(s.requireUser(s.adminUsersSubmit))},
		...
		routes = append(routes,
			...
			Route{Method: "POST", Pattern: "/{owner}/{repo}/watch", Mutating: true,
				Handler: s.checkOrigin(s.requireUser(s.watchToggle))},
			...
			Route{Method: "POST", Pattern: "/{owner}/{repo}/builds/{n}/cancel", Mutating: true,
				Handler: s.checkOrigin(s.requireUser(s.buildCancelSubmit))},
