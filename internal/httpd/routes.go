...
func (s *Server) Routes() []Route {
	...
	routes = append(routes,
		...
		Route{Method: "GET", Pattern: "/{owner}/-/about", Handler: s.ownerPage},
		Route{Method: "GET", Pattern: "/{owner}/-/activity", Handler: s.ownerPage},
		Route{Method: "GET", Pattern: "/{owner}/-/people", Handler: s.ownerPage},
