...
e.g. =-cpus 2 -memory 4g=); unset means uncapped. bay1 runs =-cpus 3=
and no memory cap, since the e2e suite needs most of the host's 7GB.
...
=TimeoutStopSec=50min= covers the longest build. So =make deploy-runner=
