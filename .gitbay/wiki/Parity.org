...
repository list. The iOS client decodes and renders both formats,
...
| push device add             | yes | yes | no  |
| push device list            | yes | yes | no  |
| push device remove          | yes | yes | no  |
| activity push on, off       | yes | yes | no  |
