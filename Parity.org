...
=profile set= carries description, website, about and links. Editing a
profile has always been SSH-only; nothing about it is a credential,
so this is a gap rather than a rule.
