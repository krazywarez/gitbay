...
Nothing asks a *particular* person for a review. The review queue is
computed from involvement — what you own, are granted, or reach through
an org or team — so a collaborator with write access who has not touched
